...
- **广泛的格式支持:**
  - RAW 格式: `.3fr`, `.arw`, `.cr2`, `.cr3`, `.crw`, `.dcr`, `.dng`, `.erf`, `.fff`, `.iiq`, `.mos`, `.mrw`, `.nef`, `.nrw`, `.orf`, `.pef`, `.raf`, `.raw`, `.rw2`, `.rwl`, `.sr2`, `.srf`, `.srw`
  - 常规格式: `.bmp`, `.gif`, `.heic`, `.heif`, `.jpeg`, `.jpg`, `.png`, `.webp`
...
- **多帧媒体:** APNG 与 GIF 在预览中自动播放，可暂停并逐帧查看；缩略图始终只解码第一帧。
